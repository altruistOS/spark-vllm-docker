#!/bin/bash
# =============================================================================
# DeepSeek V4 Flash DSpark NVFP4 — launch-cluster.sh example
#
# Direct launch script for use with launch-cluster.sh's --launch-script mode.
# Replaces --distributed-executor-backend mp with the proper multi-node args.
# =============================================================================
